      ...
      <div className={`w-full max-w-md px-8 pt-20 pb-10 mx-4 rounded-xl shadow-2xl relative transition-all duration-300 hover:shadow-xl backdrop-blur-sm border ${
        ...
        <div className="text-center mb-8 mt-4">
          ...
          <p className={`mt-2 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            Welcome back to your Sedentary Monitor
          </p>
        </div>
            ...
            <div className="flex items-center">
              <input
                ...
                className={`h-4 w-4 focus:ring-blue-500 rounded ${
                  darkMode ? 'text-blue-500 border-gray-700' : 'text-blue-600 border-gray-300'
                }`}
              />
        ...
        <div className="mt-8 text-center">
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <Link to="/signup" className={`font-medium hover:underline transition-all duration-200 ${
              darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'
            }`}>
              Sign up
            </Link>
